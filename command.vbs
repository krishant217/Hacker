...
if Input = "favirout" OR Input = "fav" OR Input = "fav website" OR Input = "favirout website" then
Sapi.speak "Opening your favirout websites please wait..."
wshshell.run "www.youtube.com"+"www.google.com"
